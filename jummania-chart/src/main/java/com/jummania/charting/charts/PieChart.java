...
import com.jummania.charting.highlight.PieHighlighter;
import com.jummania.charting.interfaces.datasets.IPieDataSet;
import com.jummania.charting.renderer.PieChartRenderer;
...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    public boolean needsHighlight(int index) {
        ...
        for (int i = 0; i < mIndicesToHighlight.length; i++)
            ...
            if ((int) mIndicesToHighlight[i].getX() == index) return true;
    ...
    public float getRadius() {
        ...
        else return Math.min(mCircleBox.width() / 2f, mCircleBox.height() / 2f);
    }
